                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Recommendations</h6>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            ...
                                            <p class="card-text">Get personalized diet plans.</p>
                                            <a href="./dietPlan.php" class="btn btn-primary">View Diet Plan</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
